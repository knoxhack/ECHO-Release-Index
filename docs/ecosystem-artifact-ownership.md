...
| `knoxhack/ECHO-Galactic-Survey-Native-Edition` | Galactic Survey Native Edition pack manifest, gameplay evidence, and future pack assets. | `packs/galactic-survey-native-edition.json` records the unpublished Native lane until committed edition sources, GitHub Release artifacts, launcher lifecycle evidence, and real gameplay evidence exist. |
| `knoxhack/ECHO-Galactic-Survey-NeoForge-Edition` | Galactic Survey NeoForge Edition pack manifest, gameplay evidence, and future pack assets. | `packs/galactic-survey-neoforge-edition.json` records the unpublished NeoForge lane until committed edition sources, GitHub Release artifacts, launcher lifecycle evidence, and real gameplay evidence exist. |
| `knoxhack/ECHO-Galactic-Survey-Standalone-Edition` | Galactic Survey Standalone Edition pack manifest, gameplay evidence, and future pack assets. | `packs/galactic-survey-standalone-edition.json` records the unpublished Standalone lane until committed edition sources, GitHub Release artifacts, launcher lifecycle evidence, and real gameplay evidence exist. |
